# Meta decks — 4 engine-built lists (Boulder + online, 2026-07-04)

Stage 2 of the deck-prep arc. Corpus through 2026-07-01, current regime (2026-05-18+),
deterministic solver (PR #35). Lists: [meta-boulder-dimir-tempo](meta-boulder-dimir-tempo.txt),
[meta-online-dimir-tempo](meta-online-dimir-tempo.txt),
[meta-boulder-bestpick-painter](meta-boulder-bestpick-painter.txt),
...
**Boulder field** (sort = Q0.25, risk-adjusted): Painter S*=0.528 (P(best)=0.093, cov 0.48) >
...
under 0.27 — the honest read is "the Boulder field has no dominant call; Dimir Tempo is
...
best-picks are Painter (Boulder) and Doomsday (online).

## The four lists — construction + honesty notes

| List | Consensus n | Tier | Board (natural budget) | Overrides applied |
|---|---|---|---|---|
| Dimir Tempo (Boulder) | 125 (all prov.) | established | 15 (6 dedicated) | −2 Defense Grid, −1 Damping Sphere |
| Dimir Tempo (online) | 86 (online) | evolving | 15 (9 dedicated) | −2 Defense Grid, −1 Damping Sphere |
| Painter (Boulder) | 37 (all prov.) | evolving | **7 (2 dedicated)** | −2 Defense Grid |
...
- **Refills after overrides** (by considering residual, labeled in each file header): Toxic
  Deluge + Barrowgoyf + Brazen Borrower (Dimir Boulder), Toxic Deluge + Thoughtseize + Barrowgoyf
...
- **Known scorer bias carried into these lists**: the hedge spreads 1-ofs across pitch-class
  ...
  Andrew's personal board (dimir-tempo-optimized.txt) hand-corrects this; these four meta
...
`advise positioning --deck decks/dimir-tempo-current.txt --field decks/boulder-field-since-518.txt
