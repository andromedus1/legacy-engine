...
List = decks/doomsday-tempo-boulder.txt (consensus tempo camp n=47, 2026-07-04; board = engine
reference vs the Boulder field). Online swap: -1 brazen borrower -> +1 thoughtseize (3rd).
...
* engine reference board vs the boulder field (natural budget 5/15 dedicated + hedge), overrides applied; every slot 1-of = known hedge bias, tune w/ reps
...
* acquisition reality: 5 SB cards unowned (decay, bitter triumph, carpet, flusterstorm, veil) + ~14 maindeck names incl. 1 LED — this is the BUILD-LATER deck; verdict says stay dimir for boulder until the field drifts fair/prison
