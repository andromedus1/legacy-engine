...
[doomsday-tempo-boulder](doomsday-tempo-boulder.txt) / [-online](doomsday-tempo-online.txt).
...
| Lens | Boulder (107-player paper room) | Online (top-15 field, 75% mass) |
|---|---|---|
...
**The venue divergence is the finding**: the blue-heavy Boulder room (Izzet 11.2% + S&T 10.3%
...
the 2026-06-27 regime-clean lean (then: Doomsday 0.501 > Dimir 0.483 on Boulder) — that run
...
For the Boulder room Andrew actually plays in: **stay Dimir Tempo** — favored lean in the
...
trigger: adopt if Boulder's composition drifts from blue tempo toward D&T/Lands/Tron-style
