...
*Legacy · post–Undercity Informer regime · the build you've adopted, tuned for a wide, combo-and-creature Boulder paper meta*
...
- **It's a lean, not a verdict:** ~54% field coverage, all CIs overlap, and the field is
  regime-clean *global paper*, not Boulder-specific (no geo; local data is MWP aggregates).
...
## Sideboard (15) — your adopted, collection-and-Boulder-tuned build
...
This is worth being honest about: **your adopted board is a heavy Boulder-and-collection
...
|---|---|---|---|
| **Off-consensus adds** | — | +2 Massacre, +2 Hurkyl's Recall, +2 Null Rod, +2 Flusterstorm, +1 Echoing Truth, +1 Harbinger | Aimed at *your* worst matchups (white creatures, artifacts, control) — justified Boulder leans, but not standard tech |
| **Consensus staples you've dropped** | 3 Consign to Memory, 2 Sheoldred's Edict, 1 Dauthi Voidwalker | 0 / 0 / 0 | **Consign (95% consensus) is a real omission** — it's strong vs Show & Tell's colorless fatties, Eldrazi, and Tron, all present in Boulder |
...
The sideboard is a heavy Boulder/collection tune; the consensus toolbox (esp. Consign to
