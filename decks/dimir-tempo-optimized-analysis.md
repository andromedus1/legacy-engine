# Dimir Tempo — sideboard optimization analysis (Boulder, 2026-07-04)
...
258 Boulder-relevant top-finisher Dimir boards (established tier). Regenerate the raw surfaces:
`advise sideboard --deck decks/dimir-tempo-current.txt --field decks/boulder-field-current.txt --smart`
and `advise backtest --archetype "Dimir Tempo" --field decks/boulder-field-current.txt --field-scope`.
...
**Field:** the 107-player post-ban Boulder snapshot — blue plurality ~45% (Izzet 11.2%, Show&Tell
...
| Surgical (old board) | cut | dead axis — no graveyard decks in Boulder; fuel-denial covered by Dauthi with a body. |
...
matters: **7 of 9 engine picks appear in ≥20% of 258 Boulder-relevant winning boards**, achieved by
