...
summary: |
  ...
  and matchup-floor projection beside the mature advisory estimators. Local ops runs the decision refresh and detection-only format monitor under one
