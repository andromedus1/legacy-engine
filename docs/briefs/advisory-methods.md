...
| nonbasic-manabase | nonbasic-land count or dual/fetch/fast-mana-LAND copies above threshold | Wasteland, Blood Moon, Back to Basics |
| artifact-mana-reliant | nonland artifact fast-mana (Moxen, Sol Ring, Lotus Petal) copies above threshold | Null Rod, Force of Vigor, Krosan Grip, Engineered Explosives |
