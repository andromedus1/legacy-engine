...
0.483 vs Doomsday 0.501 on the regime-clean Boulder field, both leans) is the prior to
...
- Compare across both metas (Boulder field file + online provenance field); divergences
  between metas are first-class output (venue-divergence pattern), never blended.

## Results (2026-07-04, single-stride)

Venue divergence IS the finding: Boulder → Dimir (EV 50.9 vs 49.6, P(A>B)=0.56; blue-heavy
...
Dimir fully owned; Doomsday gated on a ~$1k main. Bottom line: stay Dimir for Boulder;
