...
- **Honest-degrade gating** — thin/uncovered field cells labeled low-confidence (the local field
...
Motivating session (2026-07-03): hand-computed exactly this for the maintainer's Dimir Tempo board vs the
107-player local field; surfaced Mystical Dispute (~43%) and Spell Pierce (~54%) as high-coverage
...
**Verification**: full suite green — 2419 passed (was 2308 at feature-A start). Smoke-tested end-to-end against the real DB + the live local field.
