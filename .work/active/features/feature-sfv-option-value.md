...
Unit B5, uses). On the real Dimir Tempo / the local meta-field backtest this MANUFACTURED
...
## Backtest validation — `advise backtest`, Dimir Tempo vs local field (field-scoped)
