...
collection boards (A unconstrained/acquisitions, B owned-only), Boulder + online versions.
Prior art: `decks/doomsday-tempo.txt`, `decks/doomsday-tempo-boulder.txt` + primers. The
