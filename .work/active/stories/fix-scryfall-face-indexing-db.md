...
## Layout-aware extension (2026-05-31, prompted by Andrew)
Andrew flagged that crude combined-attribute aliasing is wrong for multi-face cards ("you play the front,
...
MDFC is_land call (land-capable if any face is a land) per Andrew's chosen option — flag if you want it
narrower.
